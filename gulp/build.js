...
module.exports = function(options) {
  ...
  gulp.task('html', ['inject', 'partials'], function() {
    ...
    return gulp.src(options.tmp + '/serve/*.html')
      ...
      .pipe($.replace('bower_components/font-awesome-sass/assets/fonts/font-awesome', 'assets/fonts'))
      .pipe($.csso())
  ...
  gulp.task('fonts', function() {
    return gulp.src($.mainBowerFiles({debugging: true, main: 'assets/fonts/**/*.*'}), {base: 'bower_components'})
  ...
  gulp.task('build', ['html', 'images', 'fontPaths', 'fonts', 'other', 'misc']);
};
